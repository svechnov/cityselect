...
`git clone http://github.com/splittingred/cityselect.git ./`

Then, create the target directory where you want to create the file.

Then, navigate to the directory cityselect is now in, and do this:
...
Now, you'll want to change references to cityselect in the files in your
new copied-from-cityselect repo to whatever name of your new Extra will be. Once
...
Also, you'll want to change all the references of 'cityselect' to whatever the
